<template>
    <main class="w-full h-[55px] bg-gray-100 flex items-center justify-between px-5">
        <Input type="text" v-model="messageText" class="w-10/12 flex-1" placeholder="Type a message"
