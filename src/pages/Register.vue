<template>
    <section class="w-full h-full flex flex-col items-center justify-center">
        <div class="w-80 flex flex-col items-center">
            ...
            <p>
                Or
                <span class="text-green-500"><router-link to="/login">login to your account</router-link></span>
            </p>

            <Input type="text" label="Email" placeholder="someone@somewhere.com" class="w-full mt-10" v-model="email" />
