<template>
    <header class="w-full h-28 bg-custom-almostWhatsapp-2 flex items-end p-4 text-white">
        <div class="flex items-center">
            <ArrowLeftIcon class="w-6 cursor-pointer" @click="onBack"></ArrowLeftIcon>
    ...
    <section v-if="groupStore.newGroup.name.length > 0" class="flex w-full justify-center mt-20">
        <div
            class="bg-custom-almostWhatsapp-1 w-12 h-12 rounded-full text-white flex items-center justify-center cursor-pointer">
...
import { CameraIcon, UserGroupIcon, ArrowLeftIcon, CheckIcon } from '@heroicons/vue/24/solid';
